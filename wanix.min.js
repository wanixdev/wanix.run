    ...
    "node_modules/js-untar/build/dist/untar.js"(exports, module) {
      !function(e, r) {
        ...
        function r(r2) {
          ...
          return new e(function(e2, n2, i3) {
            var o2 = new Worker(a2), s = [];
        ...
        var a2, n = window || this, i2 = n.URL || n.webkitURL, o = { blob: { get: function() {
          ...
          for (var e2 = this.buffer, r2 = e2.byteLength, t3 = 1, a3 = new DataView(e2), n2 = [], i3 = 0; i3 < r2; ++i3) {
            var o2 = a3.getUint8(i3 * t3, true);
            n2.push(o2);
          }
...
`;
  ...
  var Wanix = class extends WanixFS {
    ...
    async loadBundle(bundle) {
      ...
      let foundWasm = false;
      (0, import_js_untar.default)(toUntar).progress((f2) => {
        if (f2.name === "wanix.wasm") {
          foundWasm = true;
          console.log("loading wasm from bundle");
          this.loadWasm(f2.buffer);
        }
      }).then(() => {
        if (!foundWasm) {
          fetch("./wanix.wasm").then((r) => r.arrayBuffer()).then(this.loadWasm);
